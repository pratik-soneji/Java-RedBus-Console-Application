...
public class AcSleeper extends Bus {
    private static double perKmPrice = 4.5;
    static String type="Ac Sleeper";
    public AcSleeper(String busNo, String driverName, String busType, String source, String destination,
    ...
    public static void setPerKmPrice(int perKmPrice) {
        AcSleeper.perKmPrice = perKmPrice;
    }
}
