...
public class ExpressBus extends Bus {
    private static double perKmPrice = 2;
    static String type="Express";
    
    public ExpressBus(String busNo, String driverName, String busType, String source, String destination,
    ...
    public static void setPerKmPrice(int perKmPrice) {
        ExpressBus.perKmPrice = perKmPrice;
    }
}
